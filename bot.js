...
client.on("ready", () => {
  ...
  client.user.setActivity(`Serving ${client.guilds.size} servers also using ar!`);
});
...
if (command === "cusannounce") {
 ...
 if (command === "contact") {
   message.reply("Contact me  By the owners discord: kierangaming1#8848 I love that you love me. And I love your support. Thank you guys!");
 }

 if (command === "invite") {
   message.channel.sendMessage("Sorry I cannot allow you to do that")
 }
 ...
 if (command == "eval") {
   if (message.author.id !== "263694962418384897") return;
   try {
     var code = args.join(" ");
